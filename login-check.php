...
$loginData = mysqli_query($connection,"SELECT * FROM user INNER JOIN role ON user.id_role=role.id_role WHERE npk_user='$username' AND password_user=md5($password)");
