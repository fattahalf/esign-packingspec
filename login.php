...
<html>
  <head>
    ...
    <title>Packing Spec E-Sign System</title>
  ...
  <body>
    <div class="login-page">
            ...
            <div class="row gx-0 align-items-stretch">
              ...
              <div class="col-lg-6">
                <div class="info d-flex justify-content-center flex-column p-4 h-100">
                  <div class="py-5">
                    <h1 class="display-6 fw-bold">Packing Spec E-Sign System</h1>
                    <p class="fw-light mb-0">production Engineering - Packing | Yamaha Indonesia Motor Mfg | 2022</p>
                  </div>
                </div>
              </div>
              <!-- Form Panel    -->
              <div class="col-lg-6 bg-white">
                <div class="d-flex align-items-center px-4 px-lg-5 h-100">
                  <form class="login-form py-5 w-100" method="post" action="login-check.php">
                    <div class="input-material-group mb-3">
                      <input class="input-material" id="login-username" type="text" name="loginUsername" autocomplete="off">
                      <label class="label-material" for="login-username">NPK</label>
                    </div>
      ...
      <div class="text-center position-absolute bottom-0 start-0 w-100 z-index-20">
        <p class="text-white">Yamaha Indonesia Motor MFG.
